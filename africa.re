...
//footnote[ap_official][AgriProtein: https://agriprotein.com/]
...
Qelasy（ケラシー）は、電気インフラが未整備の地域における教育のデジタル化に取り組むコートジボワールのスタートアップです。
...
コンテンツ入りタプレットによる教育のデジタル化や、ソーラーパネル付きのリュクサックによる電力確保で、非電力化地域での教育の機会を最大化するプロダクトを提供します。

=== ここが熱い！

 * 既に6万人以上の子供へソリューションを提供済み！
